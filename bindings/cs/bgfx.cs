...
public static partial class bgfx
{
	...
	/// <summary>
	/// Resize a frame buffer for multipe window rendering.
	/// @attention Availability depends on: `BGFX_CAPS_SWAP_CHAIN`.
	/// </summary>
	///
	...
	/// <param name="_depthFormat">Window back buffer depth format.</param>
	///
	[DllImport(DllName, EntryPoint="bgfx_resize_frame_buffer", CallingConvention = CallingConvention.Cdecl)]
	public static extern unsafe void resize_frame_buffer(FrameBufferHandle _handle, ushort _width, ushort _height, TextureFormat _format, TextureFormat _depthFormat);
