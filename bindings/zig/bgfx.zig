...
/// Resize a frame buffer for multiple window renderign
/// @attention Availability depends on: `BGFX_CAPS_SWAP_CHAIN`.
...
pub inline fn resizeFrameBuffer(_handle: FrameBufferHandle, _width: u16, _height: u16, _format: TextureFormat, _depthFormat: TextureFormat) void {
    bgfx_resize_frame_buffer(_handle, _width, _height, _format, _depthFormat);
}
extern fn bgfx_resize_frame_buffer(_handle: FrameBufferHandle, _width: u16, _height: u16, _format: TextureFormat, _depthFormat: TextureFormat) FrameBufferHandle;
