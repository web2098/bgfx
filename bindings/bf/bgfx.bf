...
public static class bgfx
{
	...
	/// <param name="_depthFormat">Window back buffer depth format.</param>
	///
	[LinkName("bgfx_resize_frame_buffer")]
	public static extern void create_frame_buffer_from_nwh(FrameBufferHandle _handle, uint16 _width, uint16 _height, TextureFormat _format, TextureFormat _depthFormat);
